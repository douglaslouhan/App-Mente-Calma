...
const RilaneScreen: React.FC = () => {
  ...
  const agentData = {
    title: "Converse com a Rilane (IA)",
    description: "Clique abaixo para abrir nossa conversa em uma nova janela e começar sua jornada de autoconhecimento.",
    imageUrl: "https://placehold.co/600x400/A185D7/FFFFFF?text=Rilane+IA", // Imagem de placeholder
    agentUrl: "https://chat.openai.com/..." // ⚠️ TROQUE PELO LINK DO SEU AGENTE
  };

  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-gray-100 p-4 sm:p-8">
      {/* Header */}
      <header className="bg-white p-4 text-center shadow-md rounded-lg mb-6">
        <h1 className="text-2xl font-bold text-[#4A2C6B]">Sua Psicóloga IA</h1>
      </header>

      {/* Card do Agente */}
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden max-w-md w-full mx-auto transform transition-all duration-300 hover:scale-105">
